      ...
      <section class="host-info">
        <div class="left">
          ...
          <p>
            ...
            mollitia repudiandae, dicta rerum, consequatur molestiae quasi animi
            quis, repellat consequuntur in. Voluptate alias
          </p>
        </div>
        <div class="right">
...
export default {
  components: { FontAwesomeIcon, reviewList, stayMap, stayCheckout, chat },
  data() {
    return {
      stay: null,
      isChatOpen: false,
