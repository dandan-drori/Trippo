			...
			<div class="social-media">
				...
				<div class="buttons-container">
					<ShareNetwork
						...
						:description="`Check out this awesome i found on Trippo!`"
						quote="This site is amazing for booking trips"
						hashtags="Trippo"
					>
						<img src="@/assets/nc-socials/colored/svgs/social-color-1_logo-facebook.svg" alt="" />
						Facebook
					</ShareNetwork>
					<ShareNetwork
						network="twitter"
						...
						hashtags="vuejs,vite"
					>
						<img src="@/assets/nc-socials/colored/svgs/social-color-1_logo-twitter.svg" alt="" />
						Twitter
					</ShareNetwork>
					<ShareNetwork
						network="linkedin"
						...
						hashtags="vuejs,vite"
					>
						<img src="@/assets/nc-socials/colored/svgs/social-color-1_logo-linkedin.svg" alt="" />
						LinkedIn
					</ShareNetwork>
				</div>
			</div>
			<div class="messaging-email">
				...
				<div class="buttons-container">
					<ShareNetwork
						...
						hashtags="Trippo"
					>
						<img src="@/assets/nc-socials/colored/svgs/social-color-1_logo-whatsapp.svg" alt="" />
						Whatsapp
					</ShareNetwork>
					<ShareNetwork
						network="email"
...
// whatsapp // ${stay.propertyType} in ${stay.loc.address} //facebook${stay.propertyType} in
${stay.loc.address}
