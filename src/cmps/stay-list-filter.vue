<template>
	<form class="filters">
		<el-dropdown :hide-on-click="false">
			<el-button>{{ pricePreview }}<i class="el-icon-arrow-down el-icon--right"></i></el-button>
			<el-dropdown-menu slot="dropdown">
				<el-dropdown-item
					...
					<div class="price-filter">
						<el-input placeholder="From price" v-model="filterBy.price[0]" type="text"></el-input>
						<el-input placeholder="To price" v-model="filterBy.price[1]" type="text"></el-input>
		...
		<div class="type-filter">
			<el-dropdown :hide-on-click="false">
				<el-button
					>{{ amenitiesPreview }}<i class="el-icon-arrow-down el-icon--right"></i
				></el-button>
				<el-dropdown-menu slot="dropdown">
					<el-dropdown-item>
