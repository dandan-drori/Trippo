<template>
	<form class="filters">
		...
		<div @click.stop class="price-modal" v-if="isPriceModalOpen">
			<el-slider style="color:black" v-model="filterBy.price" range :max="1500"> </el-slider>
			<div class="price-container">
				<input v-model="filterByLocal.price[0]" class="from-price" placeholder="From" />
				<input v-model="filterByLocal.price[1]" class="to-price" placeholder="To" />
			</div>
		...
		<div @click.stop class="types-modal" v-if="isTypesModalOpen">
			<div>
				<input v-model="filterByLocal.types" type="checkbox" value="Apartment" id="Apartment" />

				<label for="Apartment"
					><span class="material-icons"> check_box_outline_blank </span>Apartment</label
				>
			</div>
			<div>
				<input v-model="filterByLocal.types" type="checkbox" value="Vila" id="Vila" />
			...
			<div>
				<input v-model="filterByLocal.types" type="checkbox" value="Hotel" id="Hotel" />
				<span class="material-icons">
					check_box_outline_blank
				</span>
			...
			<div>
				<input v-model="filterByLocal.types" type="checkbox" value="House" id="House" />
				<span class="material-icons">
					check_box_outline_blank
				</span>
			...
			<div>
				<input v-model="filterByLocal.types" type="checkbox" value="Loft" id="Loft" />
				<span class="material-icons">
					check_box_outline_blank
				</span>
		...
		<div @click.stop class="amenities-modal" v-if="isAmenitiesModalOpen">
			<div>
				<input v-model="filterByLocal.amenities" type="checkbox" value="TV" id="TV" />
				<span class="material-icons">
					check_box_outline_blank
				</span>
			...
			<div>
				<input v-model="filterByLocal.amenities" type="checkbox" value="Wifi" id="Wifi" />
				<span class="material-icons">
					check_box_outline_blank
				</span>
			...
			<div>
				<input v-model="filterByLocal.amenities" type="checkbox" value="Shower" id="Shower" />
				<span class="material-icons">
					check_box_outline_blank
				</span>
			...
			<div>
				<input v-model="filterByLocal.amenities" type="checkbox" value="Kitchen" id="Kitchen" />
				<span class="material-icons">
					check_box_outline_blank
				</span>
			...
			<div>
				<input v-model="filterByLocal.amenities" type="checkbox" value="Pets allowed" id="Pets" />
				<span class="material-icons">
					check_box_outline_blank
				</span>
