<template>
  <section class="add-container" v-if="isAddOpen">
    <ValidationObserver v-slot="{ invalid }">
      <el-form ref="form" :model="stayToAdd">
        ...
        <el-form-item label="Price per night">
          <ValidationProvider
            rules="between:1,5000"
            name="Price amount"
            v-slot="{ errors }"
          >
            <el-input
              v-model.number="stayToAdd.price"
              :class="priceError"
            ></el-input>
            <span class="err">{{ errors[0] }}</span>
          </ValidationProvider>
        ...
        <el-form-item label="Max guests">
          ...
          >
            <el-input
              v-model.number="stayToAdd.accommodates"
              :class="accError"
            ></el-input>
            <span class="err">{{ errors[0] }}</span>
          </ValidationProvider>
...
export default {
  ...
  data() {
    ...
    //   errors: [
    //     'Please fill stay name',
    //     'Above 0 please in price field',
    //     'Above 0 please in guests field',
    //   ],
    // };
  },
  methods: {
