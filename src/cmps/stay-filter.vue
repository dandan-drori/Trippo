	...
	<div class="filter-container">
		<form action="" @submit.prevent="search">
			<div class="loc-input">
				...
				<input type="text" placeholder="Where are you going" v-model="filterBy.city" />
			</div>
			...
			<div class="guests-input" @click="toggleGuestsModal">
				...
				<div class="guests-modal" v-if="isGuestsModalOpen" @click.stop>
					<div class="type">
						...
						<el-input-number v-model="adults" :min="0" :max="100"></el-input-number>
					</div>
					<div class="type">
						<div class="details">
							<p>Children</p>
						...
						<el-input-number v-model="children" :min="0" :max="100"></el-input-number>
					</div>
					<div class="type">
						<div class="details">
							<p>Infants</p>
						...
						<el-input-number v-model="infants" :min="0" :max="100"></el-input-number>
					</div>
				</div>
			</div>
		</form>
