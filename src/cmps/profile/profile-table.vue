<template>
	<ul>
		...
		<li v-for="order in orders" :key="order._id" class="table-row">
			...
			<div :class="{ orders: showActions }">{{ longText(order.stay.name) }}</div>
			<div :class="{ orders: showActions }">{{ order.createdAt | moment('from') }}</div>
			<div :class="{ orders: showActions }">{{ order.startDate | moment('MM/DD/YY') }}</div>
			<div :class="{ orders: showActions }">{{ order.endDate | moment('MM/DD/YY') }}</div>
			<div
				:class="{
